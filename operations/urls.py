...
urlpatterns = [
    ...
    path(
        "weekly-report/riders/export.csv/",
        views.METableExportView.as_view(table="weekly_report_riders", export_format="csv"),
        name="weekly_report_riders_export_csv",
    ),
    path(
        "weekly-report/riders/export.xlsx/",
        views.METableExportView.as_view(table="weekly_report_riders", export_format="xlsx"),
        name="weekly_report_riders_export_xlsx",
    ),
    path(
        "weekly-report/drivers/export.csv/",
        views.METableExportView.as_view(table="weekly_report_drivers", export_format="csv"),
        name="weekly_report_drivers_export_csv",
    ),
    path(
        "weekly-report/drivers/export.xlsx/",
    ...
    path(
        "me/metrics/overview/export.csv/",
        views.METableExportView.as_view(table="overview", export_format="csv"),
        name="me_metrics_overview_export_csv",
    ),
    path(
        "me/metrics/overview/export.xlsx/",
        views.METableExportView.as_view(table="overview", export_format="xlsx"),
        name="me_metrics_overview_export_xlsx",
    ),
