...
from ..selectors import monday_of_local_today, week_range_label, week_start_from_request
...
class WeeklyReportView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ctx["weekly_report_prev_week"] = (week_start - timedelta(days=7)).isoformat()
        ctx["weekly_report_next_week"] = (week_start + timedelta(days=7)).isoformat()
